...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.gen.eclipsemodel.PartCategory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartCategoryItemProvider
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public PartCategoryItemProvider(AdapterFactory adapterFactory)
  {
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EclipsemodelPackage.Literals.PART_CATEGORY__NAME,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EclipsemodelPackage.Literals.PART_CATEGORY__PART_CATEGORY_ID,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(EclipsemodelPackage.Literals.PART_CATEGORY__PARTS);
    }
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/PartCategory"));
  }
  ...
  {
    String label = ((PartCategory)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_PartCategory_type") :
      getString("_UI_PartCategory_type") + " " + label;
  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (EclipsemodelPackage.Literals.PART_CATEGORY__PARTS,
         EclipsemodelFactory.eINSTANCE.createView()));

    newChildDescriptors.add
      (createChildParameter
        (EclipsemodelPackage.Literals.PART_CATEGORY__PARTS,
         EclipsemodelFactory.eINSTANCE.createEditor()));
  }
