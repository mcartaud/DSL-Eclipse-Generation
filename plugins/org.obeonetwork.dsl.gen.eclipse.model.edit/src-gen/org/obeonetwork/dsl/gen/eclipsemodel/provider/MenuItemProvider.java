...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.gen.eclipsemodel.Menu} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EclipsemodelPackage.Literals.MENU__NAME,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(EclipsemodelPackage.Literals.MENU__BINDING);
      childrenFeatures.add(EclipsemodelPackage.Literals.MENU__MENUS);
      childrenFeatures.add(EclipsemodelPackage.Literals.MENU__ACTIONS);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (EclipsemodelPackage.Literals.MENU__BINDING,
         EclipsemodelFactory.eINSTANCE.createBinding()));

    newChildDescriptors.add
      (createChildParameter
        (EclipsemodelPackage.Literals.MENU__MENUS,
         EclipsemodelFactory.eINSTANCE.createMenu()));

    newChildDescriptors.add
      (createChildParameter
        (EclipsemodelPackage.Literals.MENU__ACTIONS,
