...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.gen.eclipsemodel.ActionSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EclipsemodelPackage.Literals.ACTION_SET__NAME,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EclipsemodelPackage.Literals.ACTION_SET__ID,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(EclipsemodelPackage.Literals.ACTION_SET__MENUS);
      childrenFeatures.add(EclipsemodelPackage.Literals.ACTION_SET__ACTIONS);
    }
  ...
  {
    String label = ((ActionSet)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_ActionSet_type") :
      getString("_UI_ActionSet_type") + " " + label;
  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (EclipsemodelPackage.Literals.ACTION_SET__MENUS,
         EclipsemodelFactory.eINSTANCE.createMenu()));

    newChildDescriptors.add
      (createChildParameter
        (EclipsemodelPackage.Literals.ACTION_SET__ACTIONS,
         EclipsemodelFactory.eINSTANCE.createAction()));
  }
