...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.gen.eclipsemodel.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
  ...
  public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
  {
    if (itemPropertyDescriptors == null)
    {
      ...
      addServiceKindsPropertyDescriptor(object);
    }
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EclipsemodelPackage.Literals.SERVICE__NAME,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EclipsemodelPackage.Literals.SERVICE__SERVICE_ID,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  /**
   * This adds a property descriptor for the Service Kinds feature.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected void addServiceKindsPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Service_serviceKinds_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Service_serviceKinds_feature", "_UI_Service_type"),
         EclipsemodelPackage.Literals.SERVICE__SERVICE_KINDS,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
