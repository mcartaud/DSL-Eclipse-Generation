...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.gen.eclipsemodel.Binding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         EclipsemodelPackage.Literals.BINDING__NAME,
         true,
         false,
         false,
  ...
  protected void addKeyPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Binding_key_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Binding_key_feature", "_UI_Binding_type"),
         EclipsemodelPackage.Literals.BINDING__KEY,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
