 ...
 * @generated
 */
public class ImportedPackageDeclarationItemProvider
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         getString("_UI_PropertyDescriptor_description", "_UI_ImportedPackageDeclaration_packageName_feature", "_UI_ImportedPackageDeclaration_type"),
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         getString("_UI_PropertyDescriptor_description", "_UI_ImportedPackageDeclaration_packageVersion_feature", "_UI_ImportedPackageDeclaration_type"),
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/ImportedPackageDeclaration"));
  }
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      ...
      getString("_UI_ImportedPackageDeclaration_type") + " " + label;
  }
