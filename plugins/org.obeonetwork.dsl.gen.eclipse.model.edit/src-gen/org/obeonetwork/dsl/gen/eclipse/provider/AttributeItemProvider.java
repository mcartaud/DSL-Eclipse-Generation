...
public class AttributeItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				EclipsePackage.Literals.ATTRIBUTE__NAME, true, false, false,
	...
	protected void addRequiredPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_Attribute_required_feature",
								"_UI_Attribute_type"),
						EclipsePackage.Literals.ATTRIBUTE__REQUIRED, true,
						false, false,
	...
	protected void addTranslatablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Attribute_translatable_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_Attribute_translatable_feature",
						"_UI_Attribute_type"),
				EclipsePackage.Literals.ATTRIBUTE__TRANSLATABLE, true, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				EclipsePackage.Literals.ATTRIBUTE__TYPE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
