 ...
 * @generated
 */
public class BundleItemProvider extends ProjectItemProvider implements
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Bundle_version_feature", "_UI_Bundle_type"),
				EclipsePackage.Literals.BUNDLE__VERSION, true, false, false,
	...
	protected void addRequiredEnvironmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Bundle_requiredEnvironment_feature",
						"_UI_Bundle_type"),
				EclipsePackage.Literals.BUNDLE__REQUIRED_ENVIRONMENT, true,
	...
	protected void addVendorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Bundle_vendor_feature", "_UI_Bundle_type"),
				EclipsePackage.Literals.BUNDLE__VENDOR, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(EclipsePackage.Literals.BUNDLE__DECLARATIVE_SERVICES);
			childrenFeatures
					.add(EclipsePackage.Literals.BUNDLE__IMPORTED_PACKAGE_DECLARATIONS);
			...
			childrenFeatures
					.add(EclipsePackage.Literals.BUNDLE__EXTENSION_POINTS);
