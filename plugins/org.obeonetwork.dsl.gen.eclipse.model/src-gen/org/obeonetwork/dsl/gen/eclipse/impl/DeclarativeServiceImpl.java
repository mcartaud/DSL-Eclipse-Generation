 ...
 * @generated
 */
public class DeclarativeServiceImpl extends MinimalEObjectImpl.Container implements DeclarativeService
{
  /**
   ...
   * @ordered
   */
  protected EClass implentationClass;
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EclipsePackage.DECLARATIVE_SERVICE__NAME, oldName, name));
  }
   ...
   * @generated
   */
  public EClass getImplentationClass()
  {
    if (implentationClass != null && implentationClass.eIsProxy())
    {
      ...
      implentationClass = (EClass)eResolveProxy(oldImplentationClass);
      if (implentationClass != oldImplentationClass)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EclipsePackage.DECLARATIVE_SERVICE__IMPLENTATION_CLASS, oldImplentationClass, implentationClass));
      }
    }
   ...
   * @generated
   */
  public EClass basicGetImplentationClass()
  {
    return implentationClass;
  }
   ...
   * @generated
   */
  public void setImplentationClass(EClass newImplentationClass)
  {
    EClass oldImplentationClass = implentationClass;
    implentationClass = newImplentationClass;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EclipsePackage.DECLARATIVE_SERVICE__IMPLENTATION_CLASS, oldImplentationClass, implentationClass));
  }
  ...
  public EList<ProvidedService> getProvidedServices()
  {
    ...
    {
      providedServices = new EObjectContainmentEList<ProvidedService>(ProvidedService.class, this, EclipsePackage.DECLARATIVE_SERVICE__PROVIDED_SERVICES);
    }
  ...
  public EList<RequiredService> getRequiredServices()
  {
    ...
    {
      requiredServices = new EObjectContainmentEList<RequiredService>(RequiredService.class, this, EclipsePackage.DECLARATIVE_SERVICE__REQUIRED_SERVICES);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case EclipsePackage.DECLARATIVE_SERVICE__IMPLENTATION_CLASS:
        if (resolve) return getImplentationClass();
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case EclipsePackage.DECLARATIVE_SERVICE__NAME:
        ...
        return;
      case EclipsePackage.DECLARATIVE_SERVICE__IMPLENTATION_CLASS:
        setImplentationClass((EClass)newValue);
        return;
      case EclipsePackage.DECLARATIVE_SERVICE__PROVIDED_SERVICES:
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      case EclipsePackage.DECLARATIVE_SERVICE__NAME:
        ...
        return;
      case EclipsePackage.DECLARATIVE_SERVICE__IMPLENTATION_CLASS:
        setImplentationClass((EClass)null);
        return;
      case EclipsePackage.DECLARATIVE_SERVICE__PROVIDED_SERVICES:
        getProvidedServices().clear();
        return;
