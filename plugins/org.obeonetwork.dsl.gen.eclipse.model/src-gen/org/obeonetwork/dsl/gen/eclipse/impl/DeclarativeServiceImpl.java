 ...
 * @generated
 */
public class DeclarativeServiceImpl extends EObjectImpl implements DeclarativeService {
	/**
	...
	public void setServiceClassName(String newServiceClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EclipsePackage.DECLARATIVE_SERVICE__SERVICE_CLASS_NAME, oldServiceClassName, serviceClassName));
	}
	...
	public GenClass getDelegatorClass() {
		if (delegatorClass != null && delegatorClass.eIsProxy()) {
			...
			if (delegatorClass != oldDelegatorClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EclipsePackage.DECLARATIVE_SERVICE__DELEGATOR_CLASS, oldDelegatorClass, delegatorClass));
			}
		}
	...
	public void setDelegatorClass(GenClass newDelegatorClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EclipsePackage.DECLARATIVE_SERVICE__DELEGATOR_CLASS, oldDelegatorClass, delegatorClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EclipsePackage.DECLARATIVE_SERVICE__DELEGATOR_CLASS:
				if (resolve) return getDelegatorClass();
