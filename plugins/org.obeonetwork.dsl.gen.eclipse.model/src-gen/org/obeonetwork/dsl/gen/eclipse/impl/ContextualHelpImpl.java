 ...
 * <ul>
 *   <li>{@link org.obeonetwork.dsl.gen.eclipse.impl.ContextualHelpImpl#getContextualHelpID <em>Contextual Help ID</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.gen.eclipse.impl.ContextualHelpImpl#getPage <em>Page</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContextualHelpImpl extends MinimalEObjectImpl.Container implements ContextualHelp
{
  ...
  {
    return EclipsePackage.Literals.CONTEXTUAL_HELP;
  }
  ...
  public void setContextualHelpID(String newContextualHelpID)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EclipsePackage.CONTEXTUAL_HELP__CONTEXTUAL_HELP_ID, oldContextualHelpID, contextualHelpID));
  }
  ...
  public NotificationChain basicSetPage(Page newPage, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EclipsePackage.CONTEXTUAL_HELP__PAGE, oldPage, newPage);
  ...
  public void setPage(Page newPage)
  {
    if (newPage != page)
    {
      ...
      if (page != null)
        msgs = ((InternalEObject)page).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EclipsePackage.CONTEXTUAL_HELP__PAGE, null, msgs);
      if (newPage != null)
        msgs = ((InternalEObject)newPage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EclipsePackage.CONTEXTUAL_HELP__PAGE, null, msgs);
      msgs = basicSetPage(newPage, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EclipsePackage.CONTEXTUAL_HELP__PAGE, newPage, newPage));
  }
