...
public class BindingImpl extends EObjectImpl implements Binding {
	...
	public void setKeySequence(String newKeySequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EclipsePackage.BINDING__KEY_SEQUENCE, oldKeySequence,
					keySequence));
	}
			...
			if (command != oldCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EclipsePackage.BINDING__COMMAND, oldCommand,
							command));
			}
		}
		return command;
	...
	public NotificationChain basicSetCommand(Command newCommand,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, EclipsePackage.BINDING__COMMAND,
		...
		if (newCommand != command) {
			...
			if (command != null)
				msgs = ((InternalEObject) command).eInverseRemove(this,
						EclipsePackage.COMMAND__BINDING, Command.class, msgs);
			if (newCommand != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					EclipsePackage.BINDING__COMMAND, newCommand, newCommand));
	}
	...
	public EList<Context> getContexts() {
		if (contexts == null) {
			contexts = new EObjectResolvingEList<Context>(Context.class, this,
					EclipsePackage.BINDING__CONTEXTS);
		}
		return contexts;
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case EclipsePackage.BINDING__KEY_SEQUENCE:
			return KEY_SEQUENCE_EDEFAULT == null ? keySequence != null
					: !KEY_SEQUENCE_EDEFAULT.equals(keySequence);
		case EclipsePackage.BINDING__COMMAND:
			return command != null;
		case EclipsePackage.BINDING__CONTEXTS:
