...
public class EclipseSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case EclipsePackage.PROJECT_WIZARD: {
			...
			if (result == null)
				result = caseWizard(projectWizard);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
