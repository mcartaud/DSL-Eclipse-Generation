 ...
 * <ul>
 *   <li>{@link org.obeonetwork.dsl.gen.eclipsemodel.impl.PartImpl#getPartID <em>Part ID</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.gen.eclipsemodel.impl.PartImpl#getContextualHelp <em>Contextual Help</em>}</li>
 *   <li>{@link org.obeonetwork.dsl.gen.eclipsemodel.impl.PartImpl#getPerspectives <em>Perspectives</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PartImpl extends MinimalEObjectImpl.Container implements Part
{
  ...
  {
    return EclipsemodelPackage.Literals.PART;
  }
  ...
  public void setPartID(String newPartID)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EclipsemodelPackage.PART__PART_ID, oldPartID, partID));
  }
  ...
  public NotificationChain basicSetContextualHelp(ContextualHelp newContextualHelp, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EclipsemodelPackage.PART__CONTEXTUAL_HELP, oldContextualHelp, newContextualHelp);
  ...
  public void setContextualHelp(ContextualHelp newContextualHelp)
  {
    if (newContextualHelp != contextualHelp)
    {
      ...
      if (contextualHelp != null)
        msgs = ((InternalEObject)contextualHelp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EclipsemodelPackage.PART__CONTEXTUAL_HELP, null, msgs);
      if (newContextualHelp != null)
        msgs = ((InternalEObject)newContextualHelp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EclipsemodelPackage.PART__CONTEXTUAL_HELP, null, msgs);
      msgs = basicSetContextualHelp(newContextualHelp, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EclipsemodelPackage.PART__CONTEXTUAL_HELP, newContextualHelp, newContextualHelp));
  }
  ...
  public EList<Perspective> getPerspectives()
  {
    ...
    {
      perspectives = new EObjectWithInverseResolvingEList.ManyInverse<Perspective>(Perspective.class, this, EclipsemodelPackage.PART__PERSPECTIVES, EclipsemodelPackage.PERSPECTIVE__PARTS);
    }
    return perspectives;
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EclipsemodelPackage.PART__PERSPECTIVES:
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EclipsemodelPackage.PART__CONTEXTUAL_HELP:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EclipsemodelPackage.PART__PART_ID:
        return getPartID();
      case EclipsemodelPackage.PART__CONTEXTUAL_HELP:
